    ...
    verification: {
      other: {
        'facebook-domain-verification': [
          site.seo?.facebookDomainVerification || '91w5q1s3mb6krc6ey2kpnf1fpilt5w',
        ],
      },
    },
  };
...
fbq('init', '${site.seo?.metaPixelId || '1652794879529251'}');
fbq('track', 'PageView');`,
          }}
        />
        <noscript>
          <img
            ...
            width="1"
            style={{ display: 'none' }}
            src={`https://www.facebook.com/tr?id=${site.seo?.metaPixelId || '1652794879529251'}&ev=PageView&noscript=1`}
            alt=""
          />
        </noscript>
      </head>
